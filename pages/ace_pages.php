...
<div class="wrap">
  ...
  <form method="post">
    <div id="ace_categories_usage" class="postbox">
      ...
      <div class="inside">
      	<ul>
      	 <li><?php echo sprintf(__("Here are %s different sections on the site. You can define section by section which categories would you like to hide.","ace"), count($targets)); ?></li>
      	</ul>
      </div>
    </div>
    <div class="postbox">
