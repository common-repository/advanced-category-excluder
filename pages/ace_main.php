...
global $wpdb, $ace_targets, $ace_settings, $ace_methods;
  ...
  {
    $delete_query = "DELETE FROM ".$wpdb->options." WHERE option_name LIKE 'ace_%'";
...
?>
<div class="wrap">
  <h2><?php _e('Advanced Category Excluder','ace'); ?>&nbsp;-&nbsp;<?php _e('Basic Settings','ace'); ?></h2>
  ...
  <div class="metabox-holder" id="poststuff">
    <div id="ace_main" class="postbox">
      ...
      <input class="button-primary action" type="submit" name="submit" value="<?php _e('Save','ace'); ?>"/><br /><br /><br />
      If you think, your ACE settings has been messed up. Click here, to <input class="button-secondary action" type="submit" name="cleanup" value="<?php _e('Clean up!','ace'); ?>"/> everything, and start from scratch.
      <br class="clear"/>
        </form>
    </div>
  </div>
